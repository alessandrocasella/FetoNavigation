...
def similarity_matrix_rt(frames_list, path, buffer_windows, shape, name_video):
    ...
    fps = 25.0
    video_path = os.path.join(os.getcwd(), 'similarity_matrices_rt_only_matrix', name_video)
...
if __name__ == '__main__':
    ...
    for count in range(len(name_video_list)):
        if not os.path.exists(os.path.join(os.getcwd(), 'similarity_matrices/similarity_matrices_rt_only_matrix/', name_video_list[count] + '.mp4')):
