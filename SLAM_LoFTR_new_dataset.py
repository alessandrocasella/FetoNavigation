...
name_experiment = 'SLAM_LoFTR_FINAL'  # string containing the name used to identify the experiment
...
def build_video_key_frame(list_key_frames, name_video, path_frames, mask, list_homographies, list_frames):
    ...
    print(path_panorama)
    black_canvas = cv2.imread(path_panorama, 1)
    ...
    path_panorama = os.path.join(DATASET_FILES_PATH,'output_panorama_images', name_experiment,
                                 'panorama_' + name_video + '_key_frames_panorama.png')
    # print(path_panorama)
...
def main():
    ...
    for name_video in list_videos:
        ...
        build_video_key_frame_before(list_key_frames, name_video, path_frames, mask, list_homographies, list_frames)
