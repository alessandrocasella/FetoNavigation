...
name_experiment = 'TEST_SLAM_NN_des'  # string containing the name used to identify the experiment
...
def relocalize(frame_to_relocalize_transf, matcher, mask, list_key_frames, list_key_frames_names, name_frame_to_relocalize):
    ...
    key_frame_min_dist_name = list_key_frames_names[min_index]
    tuple_result = (min_index, key_frame_min_dist, h_min_index)
    print('frame to relocalize', name_frame_to_relocalize)
    print('key frame min dist', key_frame_min_dist_name[0])
...
def main():
    ...
    for name_video in list_videos:
        ...
        tuple_result = sanity_check(name_frame_to_relocalize, frame_to_relocalize_transf, path_frames, matcher, panorama, mask,
