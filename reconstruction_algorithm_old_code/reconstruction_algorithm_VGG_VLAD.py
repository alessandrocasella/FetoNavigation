...
# Class of the used network, derived from a VGG
...
def compute_features(name_experiment, name_video, list_images, path_images, num_features_image):
    ...
    path_visual_dictionary = os.path.join(os.getcwd(), '../dataset_MICCAI_2020_files/visual_dictionary', name_experiment)
...
name_experiment = 'VGG11_VLAD_k16' #string containing the name used to identify the experiment
k_kmeans = 16
...
for name_video in list_videos:
    ...
    #num_features_image = 262144  # for VGG with k=128
    #num_features_image = 131072  # for VGG with k=64
    #num_features_image = 65536  # for VGG with k=32
    num_features_image = 32768  # for VGG with k=16
    ...
    tuple_result = sanity_check(visual_dictionary, name_experiment, frame_to_reattach, matrix_frame_to_reattach, panorama, features_key_frames, list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=1.0, ill_beta=1.0, rot=0, crop_red=0, patch_dim=0)
    experiment_result[0, index_column] = tuple_result

    # sanity check with 10 degrees rotation
    tuple_result = sanity_check(visual_dictionary, name_experiment, frame_to_reattach, matrix_frame_to_reattach, panorama, features_key_frames, list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=1.0, ill_beta=1.0, rot=10, crop_red=0, patch_dim=0)
    ...
    tuple_result = sanity_check(visual_dictionary, name_experiment, frame_to_reattach, matrix_frame_to_reattach, panorama, features_key_frames, list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=1.0, ill_beta=1.0, rot=60, crop_red=0, patch_dim=0)
    ...
    tuple_result = sanity_check(visual_dictionary, name_experiment, frame_to_reattach, matrix_frame_to_reattach, panorama, features_key_frames, list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=0.90, ill_beta=1.0, rot=0, crop_red=0, patch_dim=0)
    ...
    tuple_result = sanity_check(visual_dictionary, name_experiment, frame_to_reattach, matrix_frame_to_reattach, panorama, features_key_frames, list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=1.20, ill_beta=1.0, rot=0, crop_red=0, patch_dim=0)
    experiment_result[7, index_column] = tuple_result

    # sanity check with contrast beta=0.8
    tuple_result = sanity_check(visual_dictionary, name_experiment, frame_to_reattach, matrix_frame_to_reattach, panorama, features_key_frames,list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=1.0, ill_beta=0.8, rot=0, crop_red=0, patch_dim=0)
    experiment_result[8, index_column] = tuple_result

    # sanity check with contrast beta=0.9
    tuple_result = sanity_check(visual_dictionary, name_experiment, frame_to_reattach, matrix_frame_to_reattach, panorama, features_key_frames,list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=1.0, ill_beta=0.9, rot=0, crop_red=0, patch_dim=0)
    ...
    tuple_result = sanity_check(visual_dictionary, name_experiment, frame_to_reattach, matrix_frame_to_reattach, panorama, features_key_frames,list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=1.0, ill_beta=1.20, rot=0, crop_red=0, patch_dim=0)
    ...
    tuple_result = sanity_check(visual_dictionary, name_experiment, frame_to_reattach, matrix_frame_to_reattach, panorama, features_key_frames, list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=1.0, ill_beta=1.0, rot=0, crop_red=30, patch_dim=0)
    experiment_result[13, index_column] = tuple_result

    # sanity check crop reduction=50
    tuple_result = sanity_check(visual_dictionary, name_experiment, frame_to_reattach, matrix_frame_to_reattach, panorama, features_key_frames, list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=1.0, ill_beta=1.0, rot=0, crop_red=50, patch_dim=0)
    experiment_result[14, index_column] = tuple_result

    # sanity check with patch insertion of patch_dim=100
    tuple_result = sanity_check(visual_dictionary, name_experiment, frame_to_reattach, matrix_frame_to_reattach, panorama, features_key_frames, list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=1.0, ill_beta=1.0, rot=0, crop_red=0, patch_dim=100)
