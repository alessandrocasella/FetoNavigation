...
def extract_feature_image(img):
    ...
    features = []     # Will contain the features of the single image
...
def compute_features(name_video, list_images, path_images, num_features_image):
    ...
    path_dictionary_folder = os.path.join(os.getcwd(), 'dataset_MICCAI_2020_files/dictionary_file_npy/Batch+Patch+VLAD_kf_features_VGG_improved')
    if not os.path.exists(path_dictionary_folder):
        os.makedirs(path_dictionary_folder)

    path_visual_dictionary = os.path.join(os.getcwd(), '../dataset_MICCAI_2020_files/visual_dictionary')
...
def sanity_check(frame_to_reattach, matrix_frame_to_reattach, visual_dictionary, panorama, features_key_frames, list_key_frames, matrices_key_frames, path_images, mask, ill_alpha, ill_beta, rot, crop_red):
    ...
    # calculate the new features and reshape the result using VLAD
...
features_key_frames, visual_dictionary = compute_features(name_video, list_key_frames, path_images, num_features_image)



sanity_check(frame_to_reattach, matrix_frame_to_reattach, visual_dictionary, panorama, features_key_frames, list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=1.0, ill_beta=1.0, rot=0, crop_red=0)
print('---------------------------------------------------------------------------------------------')
sanity_check(frame_to_reattach, matrix_frame_to_reattach, visual_dictionary, panorama, features_key_frames, list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=1.0, ill_beta=1.0, rot=10, crop_red=0)
print('---------------------------------------------------------------------------------------------')
sanity_check(frame_to_reattach, matrix_frame_to_reattach, visual_dictionary,  panorama, features_key_frames, list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=1.0, ill_beta=1.0, rot=5, crop_red=0)
print('---------------------------------------------------------------------------------------------')
sanity_check(frame_to_reattach, matrix_frame_to_reattach, visual_dictionary,  panorama, features_key_frames, list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=1.10, ill_beta=1.10, rot=0, crop_red=0)
print('---------------------------------------------------------------------------------------------')
sanity_check(frame_to_reattach, matrix_frame_to_reattach, visual_dictionary,  panorama, features_key_frames, list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=0.90, ill_beta=0.90, rot=0, crop_red=0)
print('---------------------------------------------------------------------------------------------')
sanity_check(frame_to_reattach, matrix_frame_to_reattach, visual_dictionary,  panorama, features_key_frames, list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=1.0, ill_beta=1.0, rot=0, crop_red=20)
print('---------------------------------------------------------------------------------------------')
sanity_check(frame_to_reattach, matrix_frame_to_reattach, visual_dictionary,  panorama, features_key_frames, list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=1.0, ill_beta=1.0, rot=0, crop_red=30)
