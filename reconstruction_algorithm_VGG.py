...
name_experiment = 'VGG_FINAL_ALL_VIDEOS'   #string containing the name used to identify the experiment
...
# It extracts features from a given batch using weights of VGG
...
for name_video in list_videos:
    ...
    num_features_image = 346112   # for VGG
    ...
    tuple_result, metric_ssim  = sanity_check(name_experiment, frame_to_reattach, matrix_frame_to_reattach, panorama, features_key_frames, list_key_frames, matrices_key_frames, path_images, mask, ill_alpha=1.10, ill_beta=1.0, rot=0, crop_red=0, patch_dim=0)
